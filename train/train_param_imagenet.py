...
from train import utils, gebotype
from train.model_cifar10 import NetworkImageNet as Network
...
parser.add_argument('--save', type=str, default='/data/zjw/code/TENAS/checkpoints/', help='experiment name')
parser.add_argument('--seed', type=int, default=0, help='random seed')
parser.add_argument('--label_smooth', type=float, default=0.1, help='label smoothing')
parser.add_argument('--lr_scheduler', type=str, default='linear', help='lr scheduler, linear or cosine')
parser.add_argument('--tmp_data_dir', type=str, default='/data/zjt/imagenet/', help='temp data dir')
parser.add_argument('--note', type=str, default='try', help='note for this run')
parser.add_argument('--grad_clip', type=float, default=5, help='gradient clipping')
parser.add_argument('--resume', default=True, help='use checkpoint')
parser.add_argument('--dataset', default='imagenet-1k', type=str, choices=['cifar10', 'cifar100', 'ImageNet16-120', 'imagenet-1k'])
parser.add_argument('--search_space_name', default='darts', type=str)
parser.add_argument('--arch', type=str, default='PCNAS', help='which architecture to use')
...
def main():
    ...
    print('---------Genotype---------')
    # import model
    genotype = eval("gebotype.%s" % args.arch)
    print(genotype)
    ...
    # # model = gen_train_model.get_network(args)
    # if num_gpus > 1:
    ...
    # if args.resume:
    #   path_checkpoint = os.path.join('/data/zjw/code/TENAS/checkpoints/eval-try-20211124-114014/', 'checkpoint.pth.tar')  # 断点路径
