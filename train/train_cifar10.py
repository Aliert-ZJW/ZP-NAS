...
from train.model_cifar10 import NetworkCIFAR as Network
...
parser.add_argument('--save', type=str, default='/data/zjw/code/NAS_train_cifar10/TENAS-main/weight_pth/', help='experiment name')
...
def main():
  ...
  # if args.resume:
  #   path_checkpoint = os.path.join('/data/zjw/code/NAS_train_cifar10/TENAS-main/weight_pth/-20211026-114701/', 'checkpoint.pth.tar')  # 断点路径
